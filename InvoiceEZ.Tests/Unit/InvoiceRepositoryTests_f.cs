...
{
	public class InvoiceRepositoryTests_f
	{
        private Mock<IQueryable<Invoice>> _mockInvoices;
        private InvoiceRepository_f _repository;
        ...
        public void SetUp()
        {
            ...
            _repository = new InvoiceRepository_f(_mockInvoices.Object, _mockLogger.Object);
        }
        [Test]
        public void Constructor_NullInputParameter_ExceptionShouldBeThrown()
        {
            ...
            Action act = () => new InvoiceRepository_f(invoices, _mockLogger.Object);
        ...
        public void Constructor_NullInputLoggerParameter_ExceptionShouldBeThrown()
        {
            ...
            // warning is by design in this case because constuctor param is not nullable
            Action act = () => new InvoiceRepository_f(_mockInvoices.Object, logger);
